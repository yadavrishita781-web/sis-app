    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          ...
          { label: 'Approved', value: myLeaves.filter(l => l.status === 'approved').length, color: 'text-emerald-600' },
          { label: 'Pending', value: myLeaves.filter(l => l.status === 'pending').length, color: 'text-amber-600' },
        ].map(s => (
